...
public class Baysfilter : MonoBehaviour
{
	GameObject robot;
	...
	void Start()
	{
		...
		string script;
		string filename = Application.dataPath + "/../Python/Chapter8/Moderator.py";
	...
	void QLearning_start(bool init)
    {
		episode += 1;
		string script;
		string filename = Application.dataPath + "/../Python/Chapter8/Baysfilter.py";
		using (StreamReader sr = new StreamReader(filename, System.Text.Encoding.UTF8))
			script = sr.ReadToEnd();
